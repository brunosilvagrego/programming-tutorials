...
int main()
{
    // NOTE: When you define a pointer to a multidimensional array, remember that a
	...
	// NOTE: To use a multidimensional array in a range for, the loop control variable for
	...
	for (const auto &row : ia)      // for every element in the outer array
    {
        ...
        {
            cout << col << ' ';    // print the element's value
        }
	...
	/* 2. Using pointers and a traditional for loop with pointer arithmetic to calculate the end pointers */
	...
	/* 3. Using pointers and a traditional for loop with the library begin and end functions to manage the pointers */
	...
	/* Alternative way to assign positional index to elements in a two-dimensional array */
