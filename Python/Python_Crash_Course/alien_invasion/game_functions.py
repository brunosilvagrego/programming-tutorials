...
def check_events(ai_settings, screen, stats, sb, play_button, ship, aliens,
    ...
    # NOTE: Each event is connected to only one key. If the player presses both
...
def check_bullet_alien_collisions(ai_settings, screen, stats, sb, ship, aliens,
    ...
    if len(aliens) == 0:
        # If the entire fleet is destroyed, destroy existing bullets, speed up
        # game, create new fleet, and start a new level
        bullets.empty()
...
def update_aliens(ai_settings, screen, stats, sb, ship, aliens, bullets):
    """
    Check if the fleet is at an edge, and then update the postions of all aliens
    in the fleet.
    """
